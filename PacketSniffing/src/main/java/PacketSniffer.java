...
public class PacketSniffer extends javax.swing.JFrame {
    ...
    // Private variables//
    private String fileAddress; // Declared file Address for WireShark 
    private String command;     // Command e.g Ping     
    private String ipAddress;   // User IP address or website to be pinged  
    private boolean encryption; // Encryption boolean     
    ...
    private void initComponents() {
        ...
        windowGrp = new javax.swing.ButtonGroup();
        ...
        encryptionRBtn = new javax.swing.JRadioButton();
        pingRBtn = new javax.swing.JRadioButton();
        decryptionRBtn = new javax.swing.JRadioButton();
        ...
        windowGrp.add(encryptionRBtn);
        encryptionRBtn.setText("Encryption");
        encryptionRBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                encryptionRBtnActionPerformed(evt);
            }
        });

        windowGrp.add(pingRBtn);
        pingRBtn.setText("Ping");
        pingRBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pingRBtnActionPerformed(evt);
            }
        });

        windowGrp.add(decryptionRBtn);
        decryptionRBtn.setText("Decryption");
        decryptionRBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                decryptionRBtnActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(exeDecryptionBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(exeEncryptionBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(encryptionKeyLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(pingRBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(encryptionRBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(decryptionRBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(headLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 273, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(96, 96, 96))))
            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(17, 17, 17)
                        .addComponent(pingRBtn)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(encryptionRBtn)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(decryptionRBtn)
                        .addGap(18, 18, 18))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addContainerGap()
    ...
    private void wireSharkBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        try
        {
            ...
            else if (OSDetection.isMacOS()) 
            {
                try 
                {
                    Process p = Runtime.getRuntime().exec(new String[]{"open","/Applications/Wireshark.app"});
                    p.waitFor();
                } 
                //Catch an IO exception and display message//
                catch (IOException io) 
            ...
            else if (OSDetection.isLinuxOS())
            {
                try
                {
                    Process p = Runtime.getRuntime().exec(new String[]{"wireshark"});
                    p.waitFor();
                }
                catch (InterruptedException in)
                {
    ...
    private void exeEncryptionBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exeEncryptionBtnActionPerformed
        /*
         Encrypt the packet data with a key    
        */
        if(encryption=true){
           try{
               String strToEncrypt;
    ...
    private void exeDecryptionBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exeDecryptionBtnActionPerformed
        /*
         Dencrypt the packet data with a key    
        */        
        try{
            String secret;
            String strToDecrypt;
    ...
    private void pingRBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pingRBtnActionPerformed
    ...
    }//GEN-LAST:event_pingRBtnActionPerformed

    private void encryptionRBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_encryptionRBtnActionPerformed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_encryptionRBtnActionPerformed

    private void decryptionRBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_decryptionRBtnActionPerformed
        // TODO add your handling code here:
        addressLbl.setVisible(false);
        addressTf.setVisible(false);
        commandInputLbl.setVisible(true);
    ...
    }//GEN-LAST:event_decryptionRBtnActionPerformed
    ...
    public static void main(String args[]) {
         ...
         */
        try {
            if(OSDetection.isMacOS() || OSDetection.isLinuxOS()){
    ...
    private javax.swing.JRadioButton decryptionRBtn;
    ...
    private javax.swing.JRadioButton encryptionRBtn;
    ...
    private javax.swing.JRadioButton pingRBtn;
    private javax.swing.ButtonGroup windowGrp;
